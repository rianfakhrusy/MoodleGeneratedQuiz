...
$string['editinggnrquiz_help'] = 'When creating a quiz, the main concepts are:
...
$string['gnrquiz:addinstance'] = 'Add a new quiz';
$string['gnrquiz:attempt'] = 'Attempt quizzes';
$string['gnrquizavailable'] = 'The quiz is available until: {$a}';
$string['gnrquizclose'] = 'Close the quiz';
$string['gnrquizclosed'] = 'This quiz closed on {$a}';
$string['gnrquizcloses'] = 'Quiz closes';
$string['gnrquizcloseson'] = 'This quiz will close at {$a}';
$string['gnrquiz:deleteattempts'] = 'Delete quiz attempts';
...
$string['gnrquiz:grade'] = 'Grade quizzes manually';
$string['gnrquiz:ignoretimelimits'] = 'Ignores time limit on quizzes';
$string['gnrquizisclosed'] = 'This quiz is closed';
$string['gnrquizisopen'] = 'This quiz is open';
$string['gnrquizisclosedwillopen'] = 'Quiz closed (opens {$a})';
$string['gnrquizisopenwillclose'] = 'Quiz open (closes {$a})';
$string['gnrquiz:manage'] = 'Manage quizzes';
$string['gnrquiz:manageoverrides'] = 'Manage quiz overrides';
$string['gnrquiznavigation'] = 'Quiz navigation';
$string['gnrquizopen'] = 'Open the quiz';
...
$string['gnrquizopened'] = 'This quiz is open.';
$string['gnrquizopenedon'] = 'This quiz opened at {$a}';
$string['gnrquizopens'] = 'Quiz opens';
$string['gnrquizopenwillclose'] = 'This quiz is open, will close on {$a} at';
$string['gnrquizordernotrandom'] = 'Order of quiz not shuffled';
$string['gnrquizorderrandom'] = '* Order of quiz is shuffled';
$string['gnrquiz:preview'] = 'Preview quizzes';
$string['gnrquiz:regrade'] = 'Regrade quiz attempts';
$string['gnrquiz:reviewmyattempts'] = 'Review your own attempts';
$string['gnrquizsettings'] = 'Quiz settings';
$string['gnrquiz:view'] = 'View quiz information';
$string['gnrquiz:viewreports'] = 'View quiz reports';
$string['gnrquiztimer'] = 'Quiz Timer';
$string['gnrquizwillopen'] = 'This quiz will open {$a}';
