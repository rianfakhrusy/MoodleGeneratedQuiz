...
/**
 * Strings for component 'gnrquiz', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_gnrquiz
...
$string['accessnoticesheader'] = 'You can preview this gnrquiz, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have gnrquizzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the gnrquiz. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the gnrquiz. This means that different students are likely to get a different selection of questions, and when a gnrquiz allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any gnrquiz in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your gnrquiz over on the other side of this page.</p>';
...
$string['addquestionstognrquiz'] = 'Add questions to current gnrquiz';
...
$string['addrandomquestiontognrquiz'] = 'Add a random question to gnrquiz {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstognrquiz'] = 'Add selected questions to the gnrquiz';
$string['addselectedtognrquiz'] = 'Add selected to gnrquiz';
$string['addtognrquiz'] = 'Add to gnrquiz';
...
$string['attempterror'] = 'You are not allowed to attempt this gnrquiz at this time because: {$a}';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptgnrquiznow'] = 'Attempt gnrquiz now';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during gnrquiz attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtognrquiz'] = 'Back to gnrquiz editing';
$string['basicideasofgnrquiz'] = 'The basic ideas of gnrquiz-making';
...
* The gnrquiz will only start if the student has a JavaScript-enabled web-browser
* The gnrquiz appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this gnrquiz has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the gnrquiz';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this gnrquiz. The gnrquiz is set to be graded out of {$a->grade}, but none of the questions in the gnrquiz have a grade. This can be fixed on the \'Edit gnrquiz\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this gnrquiz. The gnrquiz definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this gnrquiz. The gnrquiz has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire gnrquiz attempt and start another one. This option is mainly useful for practice gnrquizzes.
...
$string['canredoquestions_help'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire gnrquiz attempt and start another one. This option is mainly useful for practice gnrquizzes.
...
$string['closebeforeopen'] = 'Could not update the gnrquiz. You have specified a close date before the open date.';
...
$string['completionattemptsexhausted_help'] = 'Mark gnrquiz complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the gnrquiz.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the gnrquiz.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the gnrquiz.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a gnrquiz after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the gnrquiz.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new gnrquiz. You can also configure which gnrquiz settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the gnrquiz grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the gnrquiz page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the gnrquiz editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during gnrquiz attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the gnrquiz.';
$string['configrequiresubnet'] = 'Students can only attempt the gnrquiz from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a gnrquiz attempt or look at the gnrquiz reports.';
$string['configshowblocks'] = 'Show blocks during gnrquiz attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this gnrquiz, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for gnrquizzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for gnrquizzes in seconds. 0 mean no time limit.';
...
$string['continueattemptgnrquiz'] = 'Continue the last attempt';
...
$string['countdownfinished'] = 'The gnrquiz is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The gnrquiz will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to gnrquiz';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the gnrquiz.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the gnrquiz a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the gnrquiz a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/gnrquiz folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new gnrquiz attempt will contain the results of the previous attempt. This allows a gnrquiz to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editinggnrquiz'] = 'Editing gnrquiz';
$string['editinggnrquiz_help'] = 'When creating a gnrquiz, the main concepts are:

* The gnrquiz, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the gnrquiz and different students can get different questions';
$string['editinggnrquiz_link'] = 'mod/gnrquiz/edit';
$string['editinggnrquizx'] = 'Editing gnrquiz: {$a}';
...
$string['editgnrquiz'] = 'Edit gnrquiz';
$string['editgnrquizquestions'] = 'Edit gnrquiz questions';
...
You can access this gnrquiz at {$a->gnrquizurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->gnrquizname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->gnrquizname}';
$string['emailnotifybody'] = 'Dear {$a->username},

{$a->studentname} has completed
\'{$a->gnrquizname}\' ({$a->gnrquizurl})
in course \'{$a->coursename}\'

You can review this attempt at {$a->gnrquizreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->gnrquizname}. See {$a->gnrquizreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->gnrquizname}';
$string['emailoverduebody'] = 'Dear {$a->studentname},

You started an attempt at \'{$a->gnrquizname}\'
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->gnrquizname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->gnrquizname}';
$string['empty'] = 'Empty';
...
$string['eventgnrquizattemptabandoned'] = 'Quiz attempt abandoned';
$string['eventgnrquizattempttimelimitexceeded'] = 'Quiz attempt time limit exceeded';
$string['eventgnrquizattemptstarted'] = 'Quiz attempt started';
$string['eventgnrquizattemptsubmitted'] = 'Quiz attempt submitted';
...
$string['formelementempty'] = 'Input a positive integer';
$string['formelementnegative'] = 'Input a positive number';
$string['formelementnumeric'] = 'Input a numeric value';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the gnrquiz. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the gnrquiz when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the gnrquiz. You have to make a trade-off based on how much you trust the performance of your server during gnrquizzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final gnrquiz grade:
...
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->gnrquizgrade}.';
$string['gradetopassnotset'] = 'This gnrquiz does not have a grade to pass set so you cannot use this option. Please use the require grade setting instead.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this gnrquiz has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt gnrquizzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a gnrquiz.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the gnrquiz';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new gnrquiz, provide this many blank overall feedback boxes. Once the gnrquiz has been created, the form shows the number of fields required for the number of feedbacks in the gnrquiz. The setting must be at least 1.';
...
$string['invalidgnrquizid'] = 'Invalid gnrquiz ID';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in gnrquiz';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->gnrquiz} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your gnrquiz attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own gnrquiz submissions';
$string['messageprovider:submission'] = 'Notification of gnrquiz submissions';
$string['max'] = 'Max';
...
$string['modulename'] = 'Generated Quiz';
$string['modulename_help'] = 'The gnrquiz activity enables a teacher to create gnrquizzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the gnrquiz to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/gnrquiz/view';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the gnrquiz in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the gnrquiz';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer gnrquizzes it makes sense to stretch the gnrquiz over several pages by limiting the number of questions per page. When adding questions to the gnrquiz, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
$string['newpageevery'] = 'Automatically start a new page';
$string['noanswers'] = 'No answers were selected!';
$string['noattempts'] = 'No attempts have been made on this gnrquiz';
...
$string['nogradewarning'] = 'This gnrquiz is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the gnrquiz settings.';
...
$string['noquestionsingnrquiz'] = 'There are no questions in this gnrquiz.';
...
$string['noreview'] = 'You are not allowed to review this gnrquiz';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this gnrquiz until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This gnrquiz is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the gnrquiz module. As a work around, set a time limit for the whole gnrquiz. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this gnrquiz';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this gnrquiz';
$string['numberabbr'] = '#';
...
$string['orderinggnrquiz'] = 'Order and paging';
$string['orderinggnrquizx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a gnrquiz has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the gnrquiz before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their gnrquiz attempt before time expires. If the student is actively working on the gnrquiz at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/gnrquiz/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this gnrquiz to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->gnrquiz} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->gnrquiz} - Override';
$string['pageshort'] = 'P';
$string['page-mod-gnrquiz-x'] = 'Any gnrquiz module page';
$string['page-mod-gnrquiz-attempt'] = 'Attempt gnrquiz page';
$string['page-mod-gnrquiz-edit'] = 'Edit gnrquiz page';
$string['page-mod-gnrquiz-report'] = 'Any gnrquiz report page';
$string['page-mod-gnrquiz-review'] = 'Review gnrquiz attempt page';
$string['page-mod-gnrquiz-summary'] = 'Quiz attempt summary page';
$string['page-mod-gnrquiz-view'] = 'Quiz information page';
...
$string['pluginname'] = 'Generated Quiz';
$string['popup'] = 'Show gnrquiz in a &quot;secure&quot; window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the gnrquiz in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this gnrquiz in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewgnrquiz'] = 'Preview {$a}';
$string['previewgnrquiznow'] = 'Preview gnrquiz now';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->gnrquiznames}<br />The question will not be deleted from these gnrquizzes but only from the category list.';
...
$string['questionsinthisgnrquiz'] = 'Questions in this gnrquiz';
...
$string['gnrquiz:addinstance'] = 'Add a new gnrquiz';
$string['gnrquiz:attempt'] = 'Attempt gnrquizzes';
$string['gnrquizavailable'] = 'The gnrquiz is available until: {$a}';
$string['gnrquizclose'] = 'Close the gnrquiz';
$string['gnrquizclosed'] = 'This gnrquiz closed on {$a}';
$string['gnrquizcloses'] = 'Quiz closes';
$string['gnrquizcloseson'] = 'This gnrquiz will close at {$a}';
$string['gnrquiz:deleteattempts'] = 'Delete gnrquiz attempts';
$string['gnrquiz:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['gnrquiz:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['gnrquiz:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['gnrquiz:grade'] = 'Grade gnrquizzes manually';
$string['gnrquiz:ignoretimelimits'] = 'Ignores time limit on gnrquizzes';
$string['gnrquizisclosed'] = 'This gnrquiz is closed';
$string['gnrquizisopen'] = 'This gnrquiz is open';
$string['gnrquizisclosedwillopen'] = 'Quiz closed (opens {$a})';
$string['gnrquizisopenwillclose'] = 'Quiz open (closes {$a})';
$string['gnrquiz:manage'] = 'Manage gnrquizzes';
$string['gnrquiz:manageoverrides'] = 'Manage gnrquiz overrides';
$string['gnrquiznavigation'] = 'Quiz navigation';
$string['gnrquizopen'] = 'Open the gnrquiz';
$string['gnrquizopenclose'] = 'Open and close dates';
$string['gnrquizopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['gnrquizopenclose_link'] = 'mod/gnrquiz/timing';
$string['gnrquizopened'] = 'This gnrquiz is open.';
$string['gnrquizopenedon'] = 'This gnrquiz opened at {$a}';
$string['gnrquizopens'] = 'Quiz opens';
$string['gnrquizopenwillclose'] = 'This gnrquiz is open, will close on {$a} at';
$string['gnrquizordernotrandom'] = 'Order of gnrquiz not shuffled';
$string['gnrquizorderrandom'] = '* Order of gnrquiz is shuffled';
$string['gnrquiz:preview'] = 'Preview gnrquizzes';
$string['gnrquiz:regrade'] = 'Regrade gnrquiz attempts';
$string['gnrquiz:reviewmyattempts'] = 'Review your own attempts';
$string['gnrquizsettings'] = 'Quiz settings';
$string['gnrquiz:view'] = 'View gnrquiz information';
$string['gnrquiz:viewreports'] = 'View gnrquiz reports';
$string['gnrquiztimer'] = 'Quiz Timer';
$string['gnrquizwillopen'] = 'This gnrquiz will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole gnrquiz to be graded.  Are you sure you want to continue?';
$string['reattemptgnrquiz'] = 'Re-attempt gnrquiz';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this gnrquiz';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradinggnrquiz'] = 'Regrading gnrquiz "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallgnrquizattempts'] = 'Delete all gnrquiz attempts';
...
$string['reportusersall'] = 'all users who have attempted the gnrquiz';
$string['reportuserswith'] = 'enrolled users who have attempted the gnrquiz';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the gnrquiz';
$string['reportuserswithout'] = 'enrolled users who have not attempted the gnrquiz';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the gnrquiz.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Quiz access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) gnrquiz, to ensure that only people in a certain location can access the gnrquiz.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to gnrquiz defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after gnrquiz is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while gnrquiz is open';
$string['reviewclosed'] = 'After the gnrquiz is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->gnrquiz} by {$a->user}';
$string['reviewopen'] = 'Later, while the gnrquiz is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a gnrquiz attempt or look at the gnrquiz reports.
...
**Later, while the gnrquiz is still open** settings apply after this, and before the gnrquiz close date.

**After the gnrquiz is closed** settings apply after the gnrquiz close date has passed. If the gnrquiz does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current gnrquiz attempt.';
...
$string['savegnrquiz'] = 'Save this whole gnrquiz';
...
$string['showblocks'] = 'Show blocks during gnrquiz attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during gnrquiz attempts';
...
$string['shufflequestions_help'] = 'If you turn this on, then every time the gnrquiz is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the gnrquiz, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotongnrquiz'] = 'Specified question is not on the specified gnrquiz';
...
$string['subneterror'] = 'Sorry, this gnrquiz has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this gnrquiz.';
$string['subnetnotice'] = 'This gnrquiz has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_gnrquiz'] = 'Report';
$string['subplugintype_gnrquiz_plural'] = 'Reports';
$string['subplugintype_gnrquizaccess'] = 'Access rule';
$string['subplugintype_gnrquizaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the gnrquiz.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the gnrquiz since you have not passed the time delay before attempting another gnrquiz';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial gnrquiz page and a countdown timer is displayed in the gnrquiz navigation block.';
$string['timelimit_link'] = 'mod/gnrquiz/timing';
...
$string['updatesettings'] = 'Update gnrquiz settings';
...
$string['upgradesure'] = '<div>In particular the gnrquiz module will perform an extensive change of the gnrquiz tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradinggnrquizattempts'] = 'Upgrading gnrquiz attempts: gnrquiz {$a->done}/{$a->outof} (Quiz id {$a->info})';
$string['upgradingveryoldgnrquizattempts'] = 'Upgrading very old gnrquiz attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this gnrquiz';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} gnrquiz attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this gnrquiz';
$string['yourfinalgradeis'] = 'Your final grade for this gnrquiz is {$a}.';
