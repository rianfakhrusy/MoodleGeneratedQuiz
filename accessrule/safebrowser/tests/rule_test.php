...
global $CFG;
require_once($CFG->dirroot . '/mod/gnrquiz/accessrule/safebrowser/rule.php');
...
class quizaccess_safebrowser_testcase extends basic_testcase {
    ...
    public function test_safebrowser_access_rule() {
        ...
        $this->assertEquals(get_string('safebrowsererror', 'gnrquizaccess_safebrowser'),
            $rule->prevent_access());

        $this->assertEquals(get_string('safebrowsernotice', 'gnrquizaccess_safebrowser'),
            $rule->description());
