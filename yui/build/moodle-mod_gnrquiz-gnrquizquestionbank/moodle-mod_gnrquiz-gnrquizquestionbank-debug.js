YUI.add('moodle-mod_gnrquiz-gnrquizquestionbank', function (Y, NAME) {
...
/**
 * Add questions from question bank functionality for a popup in gnrquiz editing page.
 *
 * @package   mod_gnrquiz
...
var CSS = {
        ...
        ADDTOGNRQUIZCONTAINER: 'td.addtognrquizaction',
...
Y.extend(POPUP, Y.Base, {
    ...
    create_dialogue: function() {
        ...
        var config = {
            ...
            postmethod: 'form',
            footerContent: null,
            extraClasses: ['mod_gnrquiz_qbank_dialogue']
        };
    ...
    load_content : function(queryString) {
        Y.log('Starting load.', 'debug', 'moodle-mod_gnrquiz-gnrquizquestionbank');
        this.dialogue.bodyNode.append(this.loadingDiv);

        // If to support old IE.
        if (window.history.replaceState) {
            window.history.replaceState(null, '', M.cfg.wwwroot + '/mod/gnrquiz/edit.php' + queryString);
        }

        Y.io(M.cfg.wwwroot + '/mod/gnrquiz/questionbank.ajax.php' + queryString, {
            method: 'GET',
            on: {
        ...
        Y.log('Load request sent.', 'debug', 'moodle-mod_gnrquiz-gnrquizquestionbank');
    },
    ...
    load_done: function(transactionid, response) {
        ...
        Y.log('Load completed.', 'debug', 'moodle-mod_gnrquiz-gnrquizquestionbank');
    ...
    load_failed: function() {
        Y.log('Load failed.', 'debug', 'moodle-mod_gnrquiz-gnrquizquestionbank');
    },

    link_clicked: function(e) {
        // Add question to gnrquiz. mofify the URL, then let it work as normal.
        if (e.currentTarget.ancestor(CSS.ADDTOGNRQUIZCONTAINER)) {
...
M.mod_gnrquiz.gnrquizquestionbank = M.mod_gnrquiz.gnrquizquestionbank || {};
M.mod_gnrquiz.gnrquizquestionbank.init = function() {
    return new POPUP();
};
