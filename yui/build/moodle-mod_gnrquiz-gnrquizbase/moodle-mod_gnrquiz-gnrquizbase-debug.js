YUI.add('moodle-mod_gnrquiz-gnrquizbase', function (Y, NAME) {

/**
 * The gnrquizbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_gnrquiz-gnrquizbase
 */
var GNRQUIZBASENAME = 'mod_gnrquiz-gnrquizbase';

var GNRQUIZBASE = function() {
    GNRQUIZBASE.superclass.constructor.apply(this, arguments);
};
 ...
 */
M.mod_gnrquiz.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_gnrquiz.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
