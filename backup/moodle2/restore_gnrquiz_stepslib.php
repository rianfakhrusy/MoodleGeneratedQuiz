...
/**
 * Structure step to restore one gnrquiz activity
 *
 * @copyright  2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_gnrquiz_activity_structure_step extends restore_questions_activity_structure_step {
    ...
    /**
     * @var bool tracks whether the gnrquiz contains at least one section. Before
     * Moodle 2.9 gnrquiz sections did not exist, so if the file being restored
     * did not contain any, we need to create one in {@link after_execute()}.
     */
    protected $sectioncreated = false;

    /**
     * @var bool when restoring old gnrquizzes (2.8 or before) this records the
     * shufflequestionsoption gnrquiz option which has moved to the gnrquiz_sections table.
     */
    ...
    protected function define_structure() {
        ...
        $gnrquiz = new restore_path_element('gnrquiz', '/activity/gnrquiz');
        $paths[] = $gnrquiz;

        // A chance for access subplugings to set up their gnrquiz data.
        $this->add_subplugin_structure('gnrquizaccess', $gnrquiz);
        ...
        if ($userinfo) {
            ...
            if ($this->task->get_old_moduleversion() > 2011010100) {
                ...
                $gnrquizattempt = new restore_path_element('gnrquiz_attempt',
                        '/activity/gnrquiz/attempts/attempt');
                $paths[] = $gnrquizattempt;

                // Add states and sessions.
                $this->add_question_usages($gnrquizattempt, $paths);

                // A chance for access subplugings to set up their attempt data.
                $this->add_subplugin_structure('gnrquizaccess', $gnrquizattempt);

            } else {
                // Restoring from a version 2.0.x+ or earlier.
                // Upgrade the legacy attempt data.
                $gnrquizattempt = new restore_path_element('gnrquiz_attempt_legacy',
                        '/activity/gnrquiz/attempts/attempt',
                        true);
                $paths[] = $gnrquizattempt;
                $this->add_legacy_question_attempt_data($gnrquizattempt, $paths);
            }
        }
    ...
    protected function process_gnrquiz($data) {
        global $CFG, $DB;
        ...
        if (property_exists($data, 'questions')) {
            ...
            $this->oldgnrquizlayout = $data->questions;
        }

        // The setting gnrquiz->attempts can come both in data->attempts and
        ...
        if (isset($data->review)) {
            ...
            if (!defined('GNRQUIZ_OLD_IMMEDIATELY')) {
                define('GNRQUIZ_OLD_IMMEDIATELY', 0x3c003f);
                define('GNRQUIZ_OLD_OPEN',        0x3c00fc0);
                define('GNRQUIZ_OLD_CLOSED',      0x3c03f000);

                define('GNRQUIZ_OLD_RESPONSES',        1*0x1041);
                define('GNRQUIZ_OLD_SCORES',           2*0x1041);
                define('GNRQUIZ_OLD_FEEDBACK',         4*0x1041);
                define('GNRQUIZ_OLD_ANSWERS',          8*0x1041);
                define('GNRQUIZ_OLD_SOLUTIONS',       16*0x1041);
                define('GNRQUIZ_OLD_GENERALFEEDBACK', 32*0x1041);
                define('GNRQUIZ_OLD_OVERALLFEEDBACK',  1*0x4440000);
            }
            ...
            $data->reviewattempt =
                    ...
                    ($oldreview & GNRQUIZ_OLD_IMMEDIATELY & GNRQUIZ_OLD_RESPONSES ?
                            mod_gnrquiz_display_options::IMMEDIATELY_AFTER : 0) |
                    ($oldreview & GNRQUIZ_OLD_OPEN & GNRQUIZ_OLD_RESPONSES ?
                            mod_gnrquiz_display_options::LATER_WHILE_OPEN : 0) |
                    ($oldreview & GNRQUIZ_OLD_CLOSED & GNRQUIZ_OLD_RESPONSES ?
                            mod_gnrquiz_display_options::AFTER_CLOSE : 0);

            $data->reviewcorrectness =
                    mod_gnrquiz_display_options::DURING |
                    ($oldreview & GNRQUIZ_OLD_IMMEDIATELY & GNRQUIZ_OLD_SCORES ?
                            mod_gnrquiz_display_options::IMMEDIATELY_AFTER : 0) |
                    ($oldreview & GNRQUIZ_OLD_OPEN & GNRQUIZ_OLD_SCORES ?
                            mod_gnrquiz_display_options::LATER_WHILE_OPEN : 0) |
                    ($oldreview & GNRQUIZ_OLD_CLOSED & GNRQUIZ_OLD_SCORES ?
                            mod_gnrquiz_display_options::AFTER_CLOSE : 0);
            ...
            $data->reviewspecificfeedback =
                    ($oldreview & GNRQUIZ_OLD_IMMEDIATELY & GNRQUIZ_OLD_FEEDBACK ?
                            mod_gnrquiz_display_options::DURING : 0) |
                    ($oldreview & GNRQUIZ_OLD_IMMEDIATELY & GNRQUIZ_OLD_FEEDBACK ?
                            mod_gnrquiz_display_options::IMMEDIATELY_AFTER : 0) |
                    ($oldreview & GNRQUIZ_OLD_OPEN & GNRQUIZ_OLD_FEEDBACK ?
                            mod_gnrquiz_display_options::LATER_WHILE_OPEN : 0) |
                    ($oldreview & GNRQUIZ_OLD_CLOSED & GNRQUIZ_OLD_FEEDBACK ?
                            mod_gnrquiz_display_options::AFTER_CLOSE : 0);

            $data->reviewgeneralfeedback =
                    ($oldreview & GNRQUIZ_OLD_IMMEDIATELY & GNRQUIZ_OLD_GENERALFEEDBACK ?
                            mod_gnrquiz_display_options::DURING : 0) |
                    ($oldreview & GNRQUIZ_OLD_IMMEDIATELY & GNRQUIZ_OLD_GENERALFEEDBACK ?
                            mod_gnrquiz_display_options::IMMEDIATELY_AFTER : 0) |
                    ($oldreview & GNRQUIZ_OLD_OPEN & GNRQUIZ_OLD_GENERALFEEDBACK ?
                            mod_gnrquiz_display_options::LATER_WHILE_OPEN : 0) |
                    ($oldreview & GNRQUIZ_OLD_CLOSED & GNRQUIZ_OLD_GENERALFEEDBACK ?
                            mod_gnrquiz_display_options::AFTER_CLOSE : 0);

            $data->reviewrightanswer =
                    ($oldreview & GNRQUIZ_OLD_IMMEDIATELY & GNRQUIZ_OLD_ANSWERS ?
                            mod_gnrquiz_display_options::DURING : 0) |
                    ($oldreview & GNRQUIZ_OLD_IMMEDIATELY & GNRQUIZ_OLD_ANSWERS ?
                            mod_gnrquiz_display_options::IMMEDIATELY_AFTER : 0) |
                    ($oldreview & GNRQUIZ_OLD_OPEN & GNRQUIZ_OLD_ANSWERS ?
                            mod_gnrquiz_display_options::LATER_WHILE_OPEN : 0) |
                    ($oldreview & GNRQUIZ_OLD_CLOSED & GNRQUIZ_OLD_ANSWERS ?
                            mod_gnrquiz_display_options::AFTER_CLOSE : 0);

            $data->reviewoverallfeedback =
                    0 |
                    ($oldreview & GNRQUIZ_OLD_IMMEDIATELY & GNRQUIZ_OLD_OVERALLFEEDBACK ?
                            mod_gnrquiz_display_options::IMMEDIATELY_AFTER : 0) |
                    ($oldreview & GNRQUIZ_OLD_OPEN & GNRQUIZ_OLD_OVERALLFEEDBACK ?
                            mod_gnrquiz_display_options::LATER_WHILE_OPEN : 0) |
                    ($oldreview & GNRQUIZ_OLD_CLOSED & GNRQUIZ_OLD_OVERALLFEEDBACK ?
                            mod_gnrquiz_display_options::AFTER_CLOSE : 0);
        }
        ...
        // Old shufflequestions setting is now stored in gnrquiz sections,
    ...
    protected function process_gnrquiz_question_instance($data) {
        ...
        if (!property_exists($data, 'slot')) {
            $page = 1;
            $slot = 1;
            foreach (explode(',', $this->oldgnrquizlayout) as $item) {
                if ($item == 0) {
                    $page += 1;
                    continue;
                }
        ...
        if (!property_exists($data, 'slot')) {
            ...
            // that was not acutally in the gnrquiz. Drop it.
            $this->log('question ' . $data->questionid . ' was associated with gnrquiz ' .
                    $this->get_new_parentid('gnrquiz') . ' but not actually used. ' .
                    'The instance has been ignored.', backup::LOG_INFO);
            return;
        }

        $data->gnrquizid = $this->get_new_parentid('gnrquiz');
    ...
    protected function process_gnrquiz_override($data) {
        ...
        $data->gnrquiz = $this->get_new_parentid('gnrquiz');
    ...
    protected function process_gnrquiz_attempt($data) {
        ...
        $this->currentgnrquizattempt = clone($data);
    }
    ...
    protected function process_gnrquiz_attempt_legacy($data) {
        ...
        $gnrquiz = $DB->get_record('gnrquiz', array('id' => $this->get_new_parentid('gnrquiz')));
        $gnrquiz->oldquestions = $this->oldgnrquizlayout;
        $this->process_legacy_gnrquiz_attempt_data($data, $gnrquiz);
    }

    protected function inform_new_usage_id($newusageid) {
        global $DB;

        $data = $this->currentgnrquizattempt;
    ...
    protected function after_execute() {
        ...
        // Add gnrquiz related files, no need to match by itemname (just internally handled context).
        $this->add_related_files('mod_gnrquiz', 'intro', null);
        // Add feedback related files, matching by itemname = 'gnrquiz_feedback'.
        $this->add_related_files('mod_gnrquiz', 'feedback', 'gnrquiz_feedback');
