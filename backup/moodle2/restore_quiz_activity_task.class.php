...
class restore_gnrquiz_activity_task extends restore_activity_task {
    ...
    public static function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('gnrquiz', 'edit override',
                'overrideedit.php?id={gnrquiz_override}', '{quiz}');
        ...
        $rules[] = new restore_log_rule('gnrquiz', 'view summary',
                'summary.php?attempt={gnrquiz_attempt}', '{quiz}');
        $rules[] = new restore_log_rule('gnrquiz', 'manualgrade',
                'comment.php?attempt={gnrquiz_attempt}&question={question}', '{quiz}');
        ...
        // one containing the gnrquiz_attempt->ids old an new for quiz-attempt.
        $rules[] = new restore_log_rule('gnrquiz', 'attempt',
                'review.php?id={course_module}&attempt={gnrquiz_attempt}', '{quiz}',
                null, null, 'review.php?attempt={gnrquiz_attempt}');
        $rules[] = new restore_log_rule('gnrquiz', 'attempt',
                'review.php?attempt={gnrquiz_attempt}', '{quiz}',
                null, null, 'review.php?attempt={gnrquiz_attempt}');
