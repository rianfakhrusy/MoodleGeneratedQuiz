...
/**
 * The mod_gnrquiz group override updated event.
 *
 * @package    mod_gnrquiz
...
/**
 * The mod_gnrquiz group override updated event class.
 *
...
class group_override_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoverrideupdated', 'mod_gnrquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the override with id '$this->objectid' for the gnrquiz with " .
