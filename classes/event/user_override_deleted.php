...
/**
 * The mod_gnrquiz user override deleted event.
 *
 * @package    mod_gnrquiz
...
/**
 * The mod_gnrquiz user override deleted event class.
 *
...
class user_override_deleted extends \core\event\base {
    ...
    public function get_url() {
        return new \moodle_url('/mod/gnrquiz/overrides.php', array('cmid' => $this->contextinstanceid));
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'gnrquiz', 'delete override', 'overrides.php?cmid=' . $this->contextinstanceid,
