...
/**
 * The mod_gnrquiz edit page viewed event.
 *
 * @package    mod_gnrquiz
...
/**
 * The mod_gnrquiz edit page viewed event class.
 *
...
class edit_page_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventeditpageviewed', 'mod_gnrquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the edit page for the gnrquiz with " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/gnrquiz/edit.php', array('cmid' => $this->contextinstanceid));
    }
