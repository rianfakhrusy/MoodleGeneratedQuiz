...
/**
 * The mod_gnrquiz attempt reviewed event.
 *
 * @package    mod_gnrquiz
...
/**
 * The mod_gnrquiz attempt reviewed event class.
 *
...
class attempt_reviewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptreviewed', 'mod_gnrquiz');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'gnrquiz', 'review', 'review.php?attempt=' . $this->objectid,
