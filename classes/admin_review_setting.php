 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_gnrquiz_admin_review_setting extends admin_setting {
    /**
     * @var integer should match the constants defined in
     * {@link mod_gnrquiz_display_options}. Copied for performance reasons.
     */
    ...
    /**
     * This should match {@link mod_gnrquiz_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return array(
            'attempt'          => get_string('theattempt', 'gnrquiz'),
            ...
            'overallfeedback'  => get_string('overallfeedback', 'gnrquiz'),
        );
    }
    ...
    protected static function times() {
        return array(
            self::DURING            => get_string('reviewduring', 'gnrquiz'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'gnrquiz'),
            self::LATER_WHILE_OPEN  => get_string('reviewopen', 'gnrquiz'),
            self::AFTER_CLOSE       => get_string('reviewclosed', 'gnrquiz'),
        );
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'gnrquiz'), $query);
    }
}
