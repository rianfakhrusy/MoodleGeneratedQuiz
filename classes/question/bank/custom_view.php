...
class custom_view extends \core_question\bank\view {
    ...
    public function add_to_gnrquiz_url($questionid) {
        ...
        return new \moodle_url('/mod/gnrquiz/edit.php', $params);
    }
    ...
    protected function display_options_form($showquestiontext, $scriptpath = '/mod/gnrquiz/edit.php',
    ...
    protected function print_category_info($category) {
        ...
        $strcategory = get_string('category', 'gnrquiz');
