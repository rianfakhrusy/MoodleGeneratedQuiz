 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gnrquiz_add_random_form extends moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('header', 'categoryheader',
                get_string('randomfromexistingcategory', 'gnrquiz'));
        ...
        $mform->addElement('checkbox', 'includesubcategories', '', get_string('recurse', 'gnrquiz'));

        $mform->addElement('select', 'numbertoadd', get_string('randomnumber', 'gnrquiz'),
                $this->get_number_of_questions_to_add_choices());

        $mform->addElement('submit', 'existingcategory', get_string('addrandomquestion', 'gnrquiz'));

        // Random from a new category section.
        $mform->addElement('header', 'categoryheader',
                get_string('randomquestionusinganewcategory', 'gnrquiz'));
        ...
        $mform->addElement('submit', 'newcategory',
                get_string('createcategoryandaddrandomquestion', 'gnrquiz'));
