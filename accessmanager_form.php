 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_gnrquiz_preflight_check_form extends moodleform {

    protected function definition() {
        $mform = $this->_form;
        $this->_form->updateAttributes(array('id' => 'mod_gnrquiz_preflight_form'));
        ...
        $this->add_action_buttons(true, get_string('startattempt', 'gnrquiz'));
    ...
    public function validation($data, $files) {
        ...
        $timenow = time();
        $accessmanager = $this->_customdata['gnrquizobj']->get_access_manager($timenow);
