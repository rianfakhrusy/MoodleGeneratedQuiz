...
$PAGE->set_url('/mod/gnrquiz/comment.php', array('attempt' => $attemptid, 'slot' => $slot));
...
if (!$attemptobj->is_finished()) {
    print_error('attemptclosed', 'gnrquiz');
}

// Check login and permissions.
require_login($attemptobj->get_course(), false, $attemptobj->get_cm());
$attemptobj->require_capability('mod/gnrquiz:grade');

// Print the page header.
$PAGE->set_pagelayout('popup');
$PAGE->set_title(get_string('manualgradequestion', 'gnrquiz', array(
...
// Quiz name.
$summarydata['gnrquizname'] = array(
    'title'   => get_string('modulename', 'gnrquiz'),
    'content' => format_string($attemptobj->get_gnrquiz_name()),
);

// Question name.
$summarydata['questionname'] = array(
    'title'   => get_string('question', 'gnrquiz'),
...
echo '<form method="post" class="mform" id="manualgradingform" action="' .
        $CFG->wwwroot . '/mod/gnrquiz/comment.php">';
