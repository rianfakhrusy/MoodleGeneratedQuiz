...
/**
 * Strings for component 'gnrquiz_overview', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['nogradepermission'] = 'You don\'t have permission to grade this gnrquiz.';
$string['onlyoneattemptallowed'] = 'Only one attempt per user allowed on this gnrquiz.';
$string['optallattempts'] = 'all attempts';
$string['optallstudents'] = 'all {$a} who have or have not attempted the gnrquiz';
$string['optattemptsonly'] = '{$a} who have attempted the gnrquiz';
$string['optnoattemptsonly'] = '{$a} who have not attempted the gnrquiz';
...
$string['showinggradedandungraded'] = 'Showing graded and ungraded attempts for each user. The one attempt for each user that is graded is highlighted. The grading method for this gnrquiz is {$a}.';
