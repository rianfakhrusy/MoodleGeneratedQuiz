...
/**
 * Class to store the options for a {@link gnrquiz_overview_report}.
 *
...
require_once($CFG->dirroot . '/mod/gnrquiz/report/attemptsreport_options.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gnrquiz_overview_options extends mod_gnrquiz_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('gnrquiz_overview_slotmarks', $this->slotmarks);
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/gnrquiz:regrade', 'mod/gnrquiz:deleteattempts'), context_module::instance($this->cm->id))
                && ($this->attempts != gnrquiz_attempts_report::ENROLLED_WITHOUT);
    }
}
