...
/**
 * Class to store the options for a {@link gnrquiz_responses_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gnrquiz_responses_options extends mod_gnrquiz_attempts_report_options {
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_capability('mod/gnrquiz:deleteattempts', context_module::instance($this->cm->id))
