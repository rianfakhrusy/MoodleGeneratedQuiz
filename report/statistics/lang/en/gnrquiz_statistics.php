...
/**
 * Strings for component 'gnrquiz_statistics', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['gnrquizinformation'] = 'Quiz information';
$string['gnrquizname'] = 'Quiz name';
$string['gnrquizoverallstatistics'] = 'Quiz overall statistics';
$string['gnrquizstructureanalysis'] = 'Quiz structure analysis';
