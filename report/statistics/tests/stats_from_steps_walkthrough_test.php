 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gnrquiz_report_statistics_from_steps_testcase extends mod_gnrquiz_attempt_walkthrough_from_csv_testcase {

    /**
     * @var gnrquiz_statistics_report object to do stats calculations.
     */
    protected $report;
     ...
     * @param $qubaids
     */
    protected function check_variants_count_for_gnrquiz_00($questions, $questionstats, $whichtries, $qubaids) {
