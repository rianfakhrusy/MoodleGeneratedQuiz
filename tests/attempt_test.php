...
/**
 * Subclass of gnrquiz_attempt to allow faking of the page layout.
 *
 * @copyright 2014 Tim Hunt
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_gnrquiz_attempt_testable extends gnrquiz_attempt {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_gnrquiz_attempt_testcase extends basic_testcase {
    /**
     * Test the functions gnrquiz_update_open_attempts() and get_list_of_overdue_attempts()
     */
    public function test_attempt_url() {
        ...
        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/attempt.php?attempt=123'),
                $attempt->attempt_url());

        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/attempt.php?attempt=123&page=2'),
                $attempt->attempt_url(null, 2));

        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/attempt.php?attempt=123&page=1#'),
                $attempt->attempt_url(3));

        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/attempt.php?attempt=123&page=1#q4'),
        ...
        // Summary page.
        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/summary.php?attempt=123'),
                $attempt->summary_url());

        // Review page.
        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/review.php?attempt=123'),
                $attempt->review_url());

        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/review.php?attempt=123&page=2'),
        ...
        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/review.php?attempt=123&page=1#q4'),
        ...
        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/review.php?attempt=123&showall=0'),
        ...
        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/review.php?attempt=124'),
                $attempt->review_url());

        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/review.php?attempt=124&page=2'),
                $attempt->review_url(null, 2));

        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/review.php?attempt=124&page=1'),
                $attempt->review_url(11, -1, false));

        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/review.php?attempt=124&page=1#q12'),
                $attempt->review_url(12, -1, false));

        $this->assertEquals(new moodle_url(
                '/mod/gnrquiz/review.php?attempt=124&showall=1'),
                $attempt->review_url(null, 2, true));
