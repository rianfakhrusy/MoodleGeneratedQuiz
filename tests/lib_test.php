...
class mod_gnrquiz_lib_testcase extends advanced_testcase {
    public function test_gnrquiz_has_grades() {
        ...
        $this->assertTrue(gnrquiz_has_grades($quiz));
        $quiz->sumgrades = '0.0000';
        $this->assertFalse(gnrquiz_has_grades($quiz));
        $quiz->grade = '0.0000';
        $this->assertFalse(gnrquiz_has_grades($quiz));
        $quiz->sumgrades = '100.0000';
        $this->assertFalse(gnrquiz_has_grades($quiz));
    ...
    public function test_gnrquiz_format_grade() {
        ...
        $this->assertEquals(gnrquiz_format_grade($quiz, 0.12345678), format_float(0.12, 2));
        $this->assertEquals(gnrquiz_format_grade($quiz, 0), format_float(0, 2));
        $this->assertEquals(gnrquiz_format_grade($quiz, 1.000000000000), format_float(1, 2));
        $quiz->decimalpoints = 0;
        $this->assertEquals(gnrquiz_format_grade($quiz, 0.12345678), '0');
    }

    public function test_gnrquiz_get_grade_format() {
        $quiz = new stdClass();
        $quiz->decimalpoints = 2;
        $this->assertEquals(gnrquiz_get_grade_format($quiz), 2);
        $this->assertEquals($quiz->questiondecimalpoints, -1);
        $quiz->questiondecimalpoints = 2;
        $this->assertEquals(gnrquiz_get_grade_format($quiz), 2);
        $quiz->decimalpoints = 3;
        $quiz->questiondecimalpoints = -1;
        $this->assertEquals(gnrquiz_get_grade_format($quiz), 3);
        $quiz->questiondecimalpoints = 4;
        $this->assertEquals(gnrquiz_get_grade_format($quiz), 4);
    }
    ...
    public function test_gnrquiz_format_question_grade() {
        ...
        $quiz->decimalpoints = 2;
        $quiz->questiondecimalpoints = 2;
        $this->assertEquals(gnrquiz_format_question_grade($quiz, 0.12345678), format_float(0.12, 2));
        $this->assertEquals(gnrquiz_format_question_grade($quiz, 0), format_float(0, 2));
        $this->assertEquals(gnrquiz_format_question_grade($quiz, 1.000000000000), format_float(1, 2));
        $quiz->decimalpoints = 3;
        $quiz->questiondecimalpoints = -1;
        $this->assertEquals(gnrquiz_format_question_grade($quiz, 0.12345678), format_float(0.123, 3));
        $this->assertEquals(gnrquiz_format_question_grade($quiz, 0), format_float(0, 3));
        $this->assertEquals(gnrquiz_format_question_grade($quiz, 1.000000000000), format_float(1, 3));
        $quiz->questiondecimalpoints = 4;
        $this->assertEquals(gnrquiz_format_question_grade($quiz, 0.12345678), format_float(0.1235, 4));
        $this->assertEquals(gnrquiz_format_question_grade($quiz, 0), format_float(0, 4));
        $this->assertEquals(gnrquiz_format_question_grade($quiz, 1.000000000000), format_float(1, 4));
    }
    ...
    public function test_gnrquiz_delete_instance() {
        ...
        gnrquiz_add_gnrquiz_question($standardq->id, $quiz);
        gnrquiz_add_random_questions($quiz, 0, $cat->id, 1, false);

        // Get the random question.
        $randomq = $DB->get_record('question', array('qtype' => 'random'));

        gnrquiz_delete_instance($quiz->id);
        ...
        $count = $DB->count_records('gnrquiz_slots', array('gnrquizid' => $quiz->id));
        $this->assertEquals(0, $count);

        // Check that the quiz was removed.
        $count = $DB->count_records('gnrquiz', array('id' => $quiz->id));
        $this->assertEquals(0, $count);
    }
    ...
    public function test_gnrquiz_get_completion_state() {
        ...
        $timenow = time();
        $attempt = gnrquiz_create_attempt($quizobj, 1, false, $timenow, false, $passstudent->id);
        ...
        $timenow = time();
        $attempt = gnrquiz_create_attempt($quizobj, 1, false, $timenow, false, $failstudent->id);
        gnrquiz_start_new_attempt($quizobj, $quba, $attempt, 1, $timenow);
        gnrquiz_attempt_save_started($quizobj, $quba, $attempt);
    ...
    public function test_gnrquiz_get_user_attempts() {
        ...
        gnrquiz_add_gnrquiz_question($question->id, $quiz1);
        gnrquiz_add_gnrquiz_question($question->id, $quiz2);
        ...
        $attempt = gnrquiz_create_attempt($quizobj1a, 1, false, $timenow, false, $u1->id);
        gnrquiz_start_new_attempt($quizobj1a, $quba1a, $attempt, 1, $timenow);
        gnrquiz_attempt_save_started($quizobj1a, $quba1a, $attempt);
        $attemptobj = gnrquiz_attempt::create($attempt->id);
        $attemptobj->process_submitted_actions($timenow, false, [1 => ['answer' => '3.14']]);
        $attemptobj->process_finish($timenow, false);

        // User 2 goes overdue in quiz 1.
        $attempt = gnrquiz_create_attempt($quizobj1b, 1, false, $timenow, false, $u2->id);
        gnrquiz_start_new_attempt($quizobj1b, $quba1b, $attempt, 1, $timenow);
        gnrquiz_attempt_save_started($quizobj1b, $quba1b, $attempt);
        $attemptobj = gnrquiz_attempt::create($attempt->id);
        $attemptobj->process_going_overdue($timenow, true);

        // User 3 does not finish quiz 1.
        $attempt = gnrquiz_create_attempt($quizobj1c, 1, false, $timenow, false, $u3->id);
        gnrquiz_start_new_attempt($quizobj1c, $quba1c, $attempt, 1, $timenow);
        gnrquiz_attempt_save_started($quizobj1c, $quba1c, $attempt);

        // User 4 abandons the quiz 1.
        $attempt = gnrquiz_create_attempt($quizobj1d, 1, false, $timenow, false, $u4->id);
        gnrquiz_start_new_attempt($quizobj1d, $quba1d, $attempt, 1, $timenow);
        gnrquiz_attempt_save_started($quizobj1d, $quba1d, $attempt);
        $attemptobj = gnrquiz_attempt::create($attempt->id);
        ...
        $attempt = gnrquiz_create_attempt($quizobj2a, 1, false, $timenow, false, $u1->id);
        gnrquiz_start_new_attempt($quizobj2a, $quba2a, $attempt, 1, $timenow);
        gnrquiz_attempt_save_started($quizobj2a, $quba2a, $attempt);
        $attemptobj = gnrquiz_attempt::create($attempt->id);
        $attemptobj->process_abandon($timenow, true);
        ...
        $attempt = gnrquiz_create_attempt($quizobj2a, 2, false, $timenow, false, $u1->id);
        gnrquiz_start_new_attempt($quizobj2a, $quba2a, $attempt, 2, $timenow);
        gnrquiz_attempt_save_started($quizobj2a, $quba2a, $attempt);
        $attemptobj = gnrquiz_attempt::create($attempt->id);
        $attemptobj->process_finish($timenow, false);
        ...
        $attempt = gnrquiz_create_attempt($quizobj2a, 3, false, $timenow, false, $u1->id);
        gnrquiz_start_new_attempt($quizobj2a, $quba2a, $attempt, 3, $timenow);
        gnrquiz_attempt_save_started($quizobj2a, $quba2a, $attempt);

        // Check for user 1.
        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u1->id, 'all');
        ...
        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u1->id, 'finished');
        $this->assertCount(1, $attempts);
        $attempt = array_shift($attempts);
        $this->assertEquals(gnrquiz_attempt::FINISHED, $attempt->state);
        $this->assertEquals($u1->id, $attempt->userid);
        ...
        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u1->id, 'unfinished');
        $this->assertCount(0, $attempts);

        // Check for user 2.
        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u2->id, 'all');
        $this->assertCount(1, $attempts);
        $attempt = array_shift($attempts);
        ...
        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u2->id, 'finished');
        $this->assertCount(0, $attempts);

        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u2->id, 'unfinished');
        $this->assertCount(1, $attempts);
        $attempt = array_shift($attempts);
        $this->assertEquals(gnrquiz_attempt::OVERDUE, $attempt->state);
        $this->assertEquals($u2->id, $attempt->userid);
        ...
        // Check for user 3.
        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u3->id, 'all');
        $this->assertCount(1, $attempts);
        $attempt = array_shift($attempts);
        ...
        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u3->id, 'finished');
        $this->assertCount(0, $attempts);

        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u3->id, 'unfinished');
        $this->assertCount(1, $attempts);
        $attempt = array_shift($attempts);
        $this->assertEquals(gnrquiz_attempt::IN_PROGRESS, $attempt->state);
        $this->assertEquals($u3->id, $attempt->userid);
        ...
        // Check for user 4.
        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u4->id, 'all');
        $this->assertCount(1, $attempts);
        $attempt = array_shift($attempts);
        ...
        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u4->id, 'finished');
        $this->assertCount(1, $attempts);
        $attempt = array_shift($attempts);
        $this->assertEquals(gnrquiz_attempt::ABANDONED, $attempt->state);
        $this->assertEquals($u4->id, $attempt->userid);
        ...
        $attempts = gnrquiz_get_user_attempts($quiz1->id, $u4->id, 'unfinished');
        $this->assertCount(0, $attempts);

        // Multiple attempts for user 1 in quiz 2.
        $attempts = gnrquiz_get_user_attempts($quiz2->id, $u1->id, 'all');
        ...
        $attempts = gnrquiz_get_user_attempts($quiz2->id, $u1->id, 'finished');
        ...
        $attempts = gnrquiz_get_user_attempts($quiz2->id, $u1->id, 'unfinished');
        $this->assertCount(1, $attempts);
        $attempt = array_shift($attempts);

        // Multiple quiz attempts fetched at once.
        $attempts = gnrquiz_get_user_attempts([$quiz1->id, $quiz2->id], $u1->id, 'all');
