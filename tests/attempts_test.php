 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_gnrquiz_attempt_overdue_testcase extends advanced_testcase {
    /**
    ...
    public function test_bulk_update_functions() {
        ...
        //
        // Test gnrquiz_update_open_attempts()
        //

        gnrquiz_update_open_attempts(array('courseid'=>$course->id));
        ...
        $this->assertEquals($DB->count_records_select('gnrquiz_attempts', 'timecheckstate IS NOT NULL'), $count);
