 ...
 * @since  Moodle 3.1
 */
class testable_mod_gnrquiz_external extends mod_gnrquiz_external {
 ...
 * @since      Moodle 3.1
 */
class mod_gnrquiz_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_view_gnrquiz() {
        ...
        assign_capability('mod/gnrquiz:view', CAP_PROHIBIT, $this->studentrole->id, $this->context->id);
    ...
    public function test_get_user_best_grade() {
        ...
        $DB->delete_records('gnrquiz_grades', array('id' => $grade->id));

    }
    /**
     * Test get_combined_review_options.
     * This is a basic test, this is already tested in mod_gnrquiz_display_options_testcase.
     */
    ...
    public function test_start_attempt() {
        ...
        // Process some responses from the student.
        $timenow = time();
        $attemptobj = gnrquiz_attempt::create($attemptid);
        $tosubmit = array(1 => array('answer' => '3.14'));
        ...
        // Test user with no capabilities.
        // We need a explicit prohibit since this capability is only defined in authenticated user and guest roles.
        assign_capability('mod/gnrquiz:attempt', CAP_PROHIBIT, $this->studentrole->id, $context->id);
        // Empty all the caches that may be affected  by this change.
        accesslib_clear_all_caches_for_unit_testing();
        course_modinfo::clear_instance_cache();
    ...
    public function test_validate_attempt() {
        ...
        $result = testable_mod_gnrquiz_external::validate_attempt($params);
    ...
    public function test_get_attempt_data() {
        ...
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::get_attempt_data_returns(), $result);
        ...
        $result = mod_gnrquiz_external::get_attempt_data($attempt->id, 1);
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::get_attempt_data_returns(), $result);
    ...
    public function test_get_attempt_summary() {
        ...
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::get_attempt_summary_returns(), $result);
    ...
    public function test_save_attempt() {
        ...
        $result = mod_gnrquiz_external::save_attempt($attempt->id, $data);
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::save_attempt_returns(), $result);
        $this->assertTrue($result['status']);
    ...
    public function test_process_attempt() {
        ...
        $result = mod_gnrquiz_external::process_attempt($attempt->id, $data);
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::process_attempt_returns(), $result);
        $this->assertEquals(gnrquiz_attempt::IN_PROGRESS, $result['state']);
        ...
        // Finish the attempt.
        $result = mod_gnrquiz_external::process_attempt($attempt->id, array(), true);
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::process_attempt_returns(), $result);
        ...
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::process_attempt_returns(), $result);
        $this->assertEquals(gnrquiz_attempt::OVERDUE, $result['state']);
        ...
        $result = mod_gnrquiz_external::process_attempt($attempt->id, array());
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::process_attempt_returns(), $result);
        $this->assertEquals(gnrquiz_attempt::ABANDONED, $result['state']);
    ...
    public function test_get_attempt_review() {
        ...
        $result = mod_gnrquiz_external::get_attempt_review($attempt->id);
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::get_attempt_review_returns(), $result);
        ...
        // Only first page.
        $result = mod_gnrquiz_external::get_attempt_review($attempt->id, 0);
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::get_attempt_review_returns(), $result);
    ...
    public function test_view_attempt() {
        ...
        $result = mod_gnrquiz_external::view_attempt($attempt->id, 0);
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::view_attempt_returns(), $result);
        $this->assertTrue($result['status']);
        ...
        try {
            mod_gnrquiz_external::view_attempt($attempt->id, 0);
    ...
    public function test_view_attempt_summary() {
        ...
        $result = mod_gnrquiz_external::view_attempt_summary($attempt->id);
    ...
    public function test_view_attempt_review() {
        ...
        $result = mod_gnrquiz_external::view_attempt_review($attempt->id, 0);
        $result = external_api::clean_returnvalue(mod_gnrquiz_external::view_attempt_review_returns(), $result);
        $this->assertTrue($result['status']);
    ...
    /**
     * Test get_gnrquiz_feedback_for_grade
     */
    ...
    /**
     * Test get_gnrquiz_access_information
     */
    ...
    public function test_get_attempt_access_information() {
        ...
        $this->assertEquals(get_string('nomoreattempts', 'gnrquiz'), $result['preventnewattemptreasons'][0]);

    }

    /**
     * Test get_gnrquiz_required_qtypes
     */
