 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_gnrquiz_attempt_walkthrough_from_csv_testcase extends advanced_testcase {
     ...
     * @return array attempt no as in csv file => the id of the gnrquiz_attempt as stored in the db.
     */
     ...
     * @param $attemptids array attempt no as in csv file => the id of the gnrquiz_attempt as stored in the db.
     */
     ...
     * @param gnrquiz_attempt $attemptobj         the attempt object loaded from db.
        ...
        foreach ($result as $fieldname => $value) {
            ...
            switch ($fieldname) {
                            ...
                            switch ($slotfieldname) {
                                case 'mark' :
                                    $this->assertEquals(round($slotvalue, 2), $attemptobj->get_question_mark($slotno),
                                                        "Mark for slot $slotno of attempt {$result['gnrquizattempt']}.");
                                    break;
                                default :
                ...
                case 'gradebookgrade' :
                    ...
                    $this->assertEquals($value, $gradebookgrade->grade, "Gradebook grade for attempt {$result['gnrquizattempt']}.");
                    break;
                default :
